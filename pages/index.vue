                  ...
                  <div class="card-body">
                    <div id="table" class="table-editable">
                      ...
                      <div class="col-sm-12 col-md-4 float-left ">
                          ...
                          <label>
                            <input type="search" class="form-control form-control-sm" placeholder="Search By Name" aria-controls="dtBasicExample" v-model="search">
                          </label>
                         
                          <button type="button" class="btn btn-success btn-rounded btn-sm my-0" @click="reset">
                            Reset
                          </button>
                      ...
                      <div class="col-sm-12 col-md-5 float-right ">
                        ...
                        <b-button @click="goToCartPage()" class="add_new_candy" size="sm">Cart 
                          <b-badge variant="light">{{ getCounter }}</b-badge></b-button>

                        <span class="table-add float-right mb-3 mr-2">
                          
                            <button class="btn btn-info btn-rounded btn-sm my-0" @click="toaddnew">
                               Add new candy
                            </button>
                        </span>
                      ...
                      <table class="table table-bordered table-responsive-md table-striped text-center">
                        ...
                        <tbody>
                            <tr v-for="(products, i) in this.getallproducts">
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-rounded btn-sm my-0" @click="Viewcandy(products.id)">
                                  View
                                </button>
                               
                                <button type="button" class="btn btn-secondary btn-rounded btn-sm my-0 editpage" @click="Editcandy(products.id)">
                                  Edit
                                </button>

                                <button type="button" class="btn btn-success btn-rounded btn-sm my-0" @click="addToCart(products)">
                                  Add to Cart
                                </button>
                            </td>
                           ...
                           <div class="item error" v-if="search && !this.getallproducts.length">
