    ...
    <div class="col-lg-12 col-md-12 " style="margin-top: 10px;">
      ...
      <form class="col-lg-6 col-md-6 " enctype="multipart/form-data">
        <div class="form-group">
            ...
            id="exampleInputEmail1" placeholder="Candy Name"
            v-model="ViewCandyForm.ProductName">
          </div>
          <div class="form-group">
          ...
          <button type="button" class="btn btn-primary on-edit"
          @click="saveupdateForm">Submit</button>
